...
github_token = os.getenv("GITHUB_TOKEN")  # Lấy từ biến môi trường
headers = {
...
def get_python_files(owner, repo, path="", branch="main"):
    ...
    try:
        ...
        print(f"Error getting python files: {e}")
        return []
...
if __name__ == "__main__":
    owner = "tensorflow"
    repo = "models"
    python_files = get_python_files(owner, repo, path="official/nlp/bert", branch="master")
